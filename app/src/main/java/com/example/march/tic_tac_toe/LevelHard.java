...
import static com.example.march.tic_tac_toe.PlayWithAndroid.f;
...
public class LevelHard {
    ...
    int proferka_2win(){
        ...
        if((array[1][1] & array[1][2]) == 2 & (array[0][0]==0 & array[0][2]==0 & array[2][2]==0) ){
            color(9);
            zaderchka(9);
            array[2][2]=2;
            return 1;
        ...
        if((array[1][1] & array[2][0]) == 2 & (array[2][1]==0 & array[2][2]==0 & array[0][1]==0) ){
            color(8);
            zaderchka(8);
            array[2][1]=2;
            return 1;
...
////////////////////////////////////////////////////////
        if((array[1][1] & array[0][1]) == 2 & (array[2][1]==0)){
            color(8);
            zaderchka(8);
            array[2][1]=2;
            return 1;
        }
        if((array[1][1] & array[2][1]) == 2 & (array[0][1]==0)){
            color(2);
            zaderchka(2);
            array[0][1]=2;
            return 1;
        }
        if((array[0][1] & array[2][1]) == 2 & (array[1][1]==0)){
            color(5);
            zaderchka(5);
            array[1][1]=2;
            return 1;
...
/////////////////////////////////////////////////////
        if((array[1][1] & array[0][2]) == 2 & (array[2][0]==0)){
            color(7);
            zaderchka(7);
            array[2][0]=2;
            return 1;
        }
        if((array[1][1] & array[2][0]) == 2 & (array[0][2]==0)){
            color(3);
            zaderchka(3);
            array[0][2]=2;
            return 1;
        }
        if((array[2][0] & array[0][2]) == 2 & (array[1][1]==0)){
            color(5);
            zaderchka(5);
            array[1][1]=2;
            return 1;
...
////////////////////////////////////////////////////
        if((array[1][1] & array[1][0]) == 2 & (array[1][2]==0)){
            color(6);
            zaderchka(6);
            array[1][2]=2;
            return 1;
        }
        if((array[1][1] & array[1][2]) == 2 & (array[1][0]==0)) {
            color(4);
            zaderchka(4);
            array[1][0] = 2;
            return 1;
        }
        if((array[1][0] & array[1][2]) == 2 & (array[1][1]==0)) {
            color(5);
            zaderchka(5);
            array[1][1] = 2;
            return 1;
...
///////////////////////////////////////////////////
        if((array[2][0] & array[2][1]) == 2 & (array[2][2]==0)){
            color(9);
            zaderchka(9);
            array[2][2] = 2;
            return 1;
        }
        if((array[2][0] & array[2][2]) == 2 &(array[2][1]==0)){
            color(8);
            zaderchka(8);
            array[2][1]=2;
            return 1;
        }
        if((array[2][1] & array[2][2]) == 2 &(array[2][0]==0)){
            color(7);
            zaderchka(7);
            array[2][0]=2;
            return 1;
...
//////////////////////////////////////////////////
        if((array[0][2] & array[1][2]) == 2 & (array[2][2]==0)){
            color(9);
            zaderchka(9);
            array[2][2]=2;
            return 1;
        }
        if((array[0][2] & array[2][2]) == 2 & (array[1][2]==0)){
            color(6);
            zaderchka(6);
            array[1][2]=2;
            return 1;
        }
        if((array[2][2] & array[1][2]) == 2 & (array[0][2]==0)){
            color(3);
            zaderchka(3);
            array[0][2]=2;
            return 1;
...
//////////////////////////////////////////////////
        if((array[0][0] & array[1][0]) == 2 & (array[2][0]==0)){
            color(7);
            zaderchka(7);
            array[2][0]=2;
            return 1;
        }
        if((array[0][0] & array[2][0]) == 2 & (array[1][0]==0)){
            color(4);
            zaderchka(4);
            array[1][0]=2;
            return 1;
        }
        if((array[2][0] & array[1][0]) == 2 & (array[0][0]==0)){
            color(1);
            zaderchka(1);
            array[0][0]=2;
            return 1;
...
/////////////////////////////////////////////////////
        if((array[0][0] & array[0][1]) == 2 & (array[0][2]==0)){
            color(3);
            zaderchka(3);
            array[0][2]=2;
            return 1;
        }
        if((array[0][0] & array[0][2]) == 2 & (array[0][1]==0)){
            color(2);
            zaderchka(2);
            array[0][1]=2;
            return 1;
        }
        if((array[0][1] & array[0][2]) == 2 & (array[0][0]==0)){
            color(1);
            zaderchka(1);
            array[0][0]=2;
            return 1;
...
//////////////////////////////////////////////////////////
        if((array[2][2] & array[1][1]) == 2 & (array[0][0]==0)){
            color(1);
            zaderchka(1);
            array[0][0]=2;
            return 1;
        }
        if((array[0][0] & array[2][2]) == 2 & (array[1][1]==0)){
            color(5);
            zaderchka(5);
            array[1][1]=2;
            return 1;
        }
        if((array[0][0] & array[1][1]) == 2 & (array[2][2]==0)){
            color(9);
            zaderchka(9);
            array[2][2]=2;
            return 1;
...
/////////////////////////////////////////////////////////////
    ...
    void proferka_2def(){
        ...
        if(nomer_hoda == 4){
            if(array[1][2]==1 & array[2][1]==1){
                array[2][2]=2;
                color(9);
                zaderchka(9);
                return;
            }
            if(array[0][2]==1 & array[2][0]==1){
                array[2][1]=2;
                color(8);
                zaderchka(8);
                return;
            }
            if(array[2][1]==1 & array[0][2]==1){
                array[1][0]=2;
                color(4);
                zaderchka(4);
                return;
            }
            if(array[1][1]==1 & array[2][2]==1){
                array[0][2]=2;
                color(3);
                zaderchka(3);
                return;
            }
            if(array[2][0]==1 & array[1][2]==1){
                array[0][1]=2;
                color(2);
                zaderchka(2);
                return;
        ...
        if (nomer_hoda == 5) {
            ...
            if(array[0][1]==1 & array[2][2]==1){
                array[2][0]=2;
                color(7);
                zaderchka(7);
                return;
            }
            if(array[0][0]==1 & array[1][2]==1){
                array[2][0]=2;
                color(7);
                zaderchka(7);
                return;
            }
            if(array[0][2]==1 & array[2][1]==1){
                array[0][0]=2;
                color(1);
                zaderchka(1);
            }
 ...
 ////////////////////////////////////////////////////
        if(nomer_hoda==5){
            if((array[2][1] & array[0][2]) == 1){
                array[1][2]=2;
                color(6);
                zaderchka(6);
                return;
            }
            if(array[1][2]==1 & array[2][0]==1){
                color(2);
                zaderchka(2);
                array[0][2]=2;
                return;
...
////////////////////////////////////////////////////////
    ...
    void defend(){
      /*  for( int j = 0; j<3; j++)
        ...
        Log.i(TAG,"Номер хода= "+nomer_hoda);
*/
        if(nomer_hoda == 2){
            if(array[1][1]==1){
                array[0][0]=2;
        ...
        }else{if(nomer_hoda == 4){
            proferka_2def();
            nomer_hoda++;
            return;
            }
        else{if(nomer_hoda==6){
            if(array[1][2]==1 & array[0][0]==1 & array[2][1]==1){
                array[2][0]=2;
                color(7);
                zaderchka(7);
                nomer_hoda++;
    ...
    void attack() {
        if (nomer_hoda == 1) {
            ...
            array[k][l] = 2;
            if(k==0 & l==0){color(1);bt1.setText("0");bt1.setEnabled(false);}
            if(k==0 & l==1){color(2);bt2.setText("O");bt2.setEnabled(false);}
            if(k==0 & l==2){color(3);bt3.setText("O");bt3.setEnabled(false);}
            if(k==1 & l==0){color(4);bt4.setText("O");bt4.setEnabled(false);}
            if(k==1 & l==1){color(5);bt5.setText("O");bt5.setEnabled(false);}
            if(k==1 & l==2){color(6);bt6.setText("O");bt6.setEnabled(false);}
            if(k==2 & l==0){color(7);bt7.setText("O");bt7.setEnabled(false);}
            if(k==2 & l==1){color(8);bt8.setText("O");bt8.setEnabled(false);}
            if(k==2 & l==2){color(9);bt9.setText("O");bt9.setEnabled(false);}
            nomer_hoda++;
            return;
        } else {
            if (nomer_hoda == 3) {
